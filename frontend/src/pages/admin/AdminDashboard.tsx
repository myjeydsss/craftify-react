  ...
  useEffect(() => {
    ...
    const fetchStatistics = async () => {
      ...
      try {
        ...
        const { count: verificationsCount, error: verificationError } =
          await supabase
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 shadow-lg rounded-md transition-transform transform hover:scale-105">
          ...
          <p className="mt-2 text-3xl font-bold text-center text-purple-500">
            {totalUsers}
          </p>
        </div>
        ...
        <div className="bg-white p-6 shadow-lg rounded-md transition-transform transform hover:scale-105">
          ...
          <p className="mt-2 text-3xl font-bold text-center text-red-500">
            {clientCount}
          </p>
        </div>
        ...
        <div className="bg-white p-6 shadow-lg rounded-md transition-transform transform hover:scale-105">
          ...
          <p className="mt-2 text-3xl font-bold text-center text-green-500">
            {artistCount}
          </p>
        </div>
        ...
        <div className="bg-white p-6 shadow-lg rounded-md transition-transform transform hover:scale-105">
          ...
          <p className="mt-2 text-3xl font-bold text-center text-blue-500">
            {verificationCount}
          </p>
        </div>
