...
const MyArts: React.FC = () => {
  ...
  if (loading) {
    return <div className="text-center mt-12">Loading arts...</div>;
  }
  ...
  return (
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      {arts.length > 0 ? (
        <div className="grid grid-cols-1 py-12 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {arts.map((art) => (
            <div
              key={art.art_id}
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600">No arts found.</p>
        </div>
      )}
