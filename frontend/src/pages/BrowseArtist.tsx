  ...
  return (
    <div className="min-h-screen bg-white px-6 py-16">
      <div className="container mx-auto">
        ...
        <h1 className="text-4xl font-bold text-[#5C0601] mb-2">Discover Artists</h1>
    ...
    >
      ...
      {matching ? (
        ...
        matchedArtists.map((match, index) => (
          <div key={index} className="flex flex-col md:flex-row justify-between items-center mb-6">
            {/* Client Section */}
            <div className="flex flex-col items-center w-full md:w-1/2 text-center mb-4 md:mb-0">
              ...
              <h3 className="text-lg md:text-2xl font-bold text-gray-800 mt-4">{match.client.name}</h3>
              <p className="text-md md:text-lg text-gray-500 mt-1">{match.client.role}</p>
            ...
            <div className="flex flex-col items-center w-full md:w-1/2 text-center">
              ...
              <h3 className="text-lg md:text-2xl font-bold text-gray-800 mt-4">{match.artist.name}</h3>
              <p className="text-md md:text-lg text-gray-500 mt-1">{match.artist.role}</p>
              <p className="text-gray-600 text-sm mt-1">
