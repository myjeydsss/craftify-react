      ...
      <div className="py-20 min-h-screen font-poppins">
        ...
        <section className="bg-gradient-to-r from-yellow-400 via-red-400 to-pink-500 text-white py-20">
          <div className="container mx-auto text-center py-2">
            ...
            <p className="text-lg mb-8">
              Bringing Artists and Art Lovers Together through a Personalized
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8 text-[#CA5310]">
              Our Mission
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed px-6 md:px-20">
              At Craftify, we are passionate about making art accessible and
              personal. We aim to connect artists with clients who want to
              commission unique, personalized pieces of art. Whether it's a
              painting, sculpture, or digital design, Craftify enables artists
              and clients to collaborate and bring their visions to life.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-r from-yellow-200 via-red-200 to-pink-200">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed px-6 md:px-20">
              At Craftify, we envision a world where every local artist has a
              platform to showcase their unique talents and connect with a
              global audience. We aim to foster creativity, build a supportive
              community for artisans, and inspire appreciation for handmade
              craftsmanship. Our goal is to empower artists and elevate the
              value of locally-made, sustainable products.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed px-6 md:px-20">
              Craftify connects art enthusiasts with talented local artisans,
              providing a space for artists to showcase and sell their
              handcrafted creations. We offer a diverse range of artistic works,
              from paintings to textiles, making it easy for customers to
              discover and collaborate with creators. By simplifying the process
              of finding and purchasing local art, we help support small
              businesses and promote the arts.
            </p>
          </div>
        </section>
              ...
              {[
                ...
                <div key={index} className="w-full md:w-1/3 p-6">
                  <div className="bg-white shadow-md p-8 rounded-lg border hover:bg-[#FBD3A7] transition-all duration-300 hover:scale-105">
                    <h3 className="text-xl font-bold mb-4 text-[#CA5310]">
                      {item.title}
                    </h3>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center">
              {[
                {
                  name: "Jhonna Mae Awayan",
                  role: "Project Manager & Project Leader",
                },
        ...
        <section className="py-20 bg-gradient-to-r from-yellow-400 via-red-400 to-pink-500 text-white">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg mb-8">
              Become a part of our vibrant community of artists and art lovers.
              Sign up now to start your journey with Craftify!
            </p>
            <button
