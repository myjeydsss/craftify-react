...
const ClientProject: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      ...
      try {
        const response = await axios.get(`${API_BASE_URL}/api/client-projects/${user.id}`);
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-poppins">
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-3xl font-extrabold text-center text-gray-900 mb-8">Client Project Tracking</h1>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-8 rounded-lg shadow-xl max-w-2xl w-full relative">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-700 mb-2">
                  <strong>Budget:</strong> {selectedProposal.budget || "No due date"}
                </p>
                <p className="text-sm text-gray-700 mb-2">
